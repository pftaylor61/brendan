...
function of_recognized_background_repeat() {
	$default = array(
		'no-repeat' => esc_html__( 'No Repeat', 'brendan' ),
		'repeat-x'  => esc_html__( 'Repeat Horizontally', 'brendan' ),
		'repeat-y'  => esc_html__( 'Repeat Vertically', 'brendan' ),
		'repeat'    => esc_html__( 'Repeat All', 'brendan' ),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => esc_html__( 'Top Left', 'brendan' ),
		'top center'    => esc_html__( 'Top Center', 'brendan' ),
		'top right'     => esc_html__( 'Top Right', 'brendan' ),
		'center left'   => esc_html__( 'Middle Left', 'brendan' ),
		'center center' => esc_html__( 'Middle Center', 'brendan' ),
		'center right'  => esc_html__( 'Middle Right', 'brendan' ),
		'bottom left'   => esc_html__( 'Bottom Left', 'brendan' ),
		'bottom center' => esc_html__( 'Bottom Center', 'brendan' ),
		'bottom right'  => esc_html__( 'Bottom Right', 'brendan')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => esc_html__( 'Scroll Normally', 'brendan' ),
		'fixed'  => esc_html__( 'Fixed in Place', 'brendan')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => esc_html__( 'Normal', 'brendan' ),
		'italic'      => esc_html__( 'Italic', 'brendan' ),
		'bold'        => esc_html__( 'Bold', 'brendan' ),
		'bold italic' => esc_html__( 'Bold Italic', 'brendan' )
		);
